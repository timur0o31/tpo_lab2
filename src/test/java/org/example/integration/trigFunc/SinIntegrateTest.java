...
public class SinIntegrateTest {
    ...
    @CsvFileSource(resources = "/integration/step2.csv", numLinesToSkip = 1)
    void testStage2Calculate(double x, double expected, double tanValue, double cotValue,
